...
class _CreateAccountPageState extends State<CreateAccountPage> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        _showErrorDialog(
            response.data?.toString() ?? 'Signup failed');
      }
    } catch (e) {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildUploadOption(Icons.camera_alt, 'Take Photo',
                'Capture with camera', () => _selectProfilePicture('camera')),
            const SizedBox(height: 12),
            _buildUploadOption(Icons.photo_library, 'Choose from Gallery',
                'Select from your photos',
                    () => _selectProfilePicture('gallery')),
          ],
        ),
      ),
    );
  ...
  Widget _buildUploadOption(
    ...
    return ListTile(
      leading: Container(
        ...
        child: Icon(icon, color: const Color(0xFFFF9500)),
      ),
      title: Text(title,
          style:
  ...
  Future<void> _selectProfilePicture(String source) async {
...
//       // 2️⃣ Call API
//       SignupService signupService = SignupService();
//       Response response = (await signupService.signup(
//         email: _emailController.text,
//         username: _fullNameController.text,
//         password: _passwordController.text,
//         confirmPassword: _confirmPasswordController.text,
...
//       } else {
//         _showErrorDialog(
//           response.data != null ? response.data.toString() : 'Signup failed',
//         );
//       }
//     } catch (e) {
//       _showErrorDialog(e.toString());
...
//           mainAxisSize: MainAxisSize.min,
//           children: [
//             const Icon(Icons.check_circle, color: Color(0xFFFF9500), size: 64),
//             const SizedBox(height: 16),
//             const Text('Account Created!',
...
//   }
//
//   void _selectProfilePicture(String source) {
//     Navigator.of(context).pop();
//     setState(() {
...
//       SnackBar(
//         content: Text('Profile picture selected from ${source == 'camera' ? 'camera' : 'gallery'}!'),
//         backgroundColor: const Color(0xFFFF9500),
//       ),
//     );
//   }
