...
class _ChatConversationPageState extends State<ChatConversationPage> {
  ...
  String channelName = "test_channel"; // Replace with your channel logic
  String appId = "YOUR_AGORA_APP_ID"; // Replace with your App ID
  ...
  Future<void> _startCall(bool isVideoCall) async {
    ...
    await _agoraEngine!.joinChannel(
      token: "null", // Use null for testing, in production use a token
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Star icon for exclusive content
          IconButton(
            icon: const Icon(Icons.star, color: Color(0xFFFF9500)),
            onPressed: () async {
              final result = await Navigator.pushNamed(
